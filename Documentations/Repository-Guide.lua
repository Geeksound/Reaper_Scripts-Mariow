...
local btn1_y = gfx.h / 2 - btn_h - spacing/2
local btn2_x = btn1_x
local btn2_y = gfx.h / 2 + spacing/2
...
-- Info
local info = "(Click a button to download the PDF guide or open GitHub repository in your browser)"
