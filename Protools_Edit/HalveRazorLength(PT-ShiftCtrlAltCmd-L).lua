--[[
@description Halve the length of Razor Edits on selected tracks
@version 1.0
@author Mariow
@changelog
  v1.0 (2025-11-26)
...
@about
  # Halve Razor Edit Duration
  Halves the length of Razor Edits on all selected tracks in REAPER.
...
reaper.Undo_OnStateChange("Halve Razor Edit duration")
