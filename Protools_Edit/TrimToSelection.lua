--[[
@description Trim items to Time Selection on selected track (ProTools-like)
@version 1.0
@author Mariow
@changelog
  v1.0 (2025-06-07)
  - Initial release
@provides
  [main] Protools_Edit/TrimToSelection.lua
@link https://github.com/Geeksound/Reaper_Scripts-Mariow
@repository https://github.com/Geeksound/Reaper_Scripts-Mariow
@tags editing, items, (protools-like)
@about
  # TrimToSelection (ProTools-like)
  Trims items to the current Time Selection on the selected track,
  emulating the behavior of Pro Tools' "Trim to Selection" edit function.
--]]
