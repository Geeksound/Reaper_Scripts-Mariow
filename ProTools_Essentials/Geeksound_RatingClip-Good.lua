--[[
@description RatingClip – Good (PT-Like)
@version 1.0
@author Mariow
@changelog
    v1.0 (2026-02-16)
    - Initial release
    - Sets clip rating to Good
@provides
    [main] ProTools_Essentials/Geeksound_RatingClip-Good.lua
@link https://github.com/Geeksound/Reaper_Scripts-Mariow
@repository https://github.com/Geeksound/Reaper_Scripts-Mariow
@tags rating, clip, protools-like, editing
@about
    # RatingClip – Good (PT-Like)

    Sets selected clips to **Good** rating
