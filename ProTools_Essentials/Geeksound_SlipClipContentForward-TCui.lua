--[[
@description Slip Clip Content FORWARD by Nudge Value (TimecodeUI)
@version 1.0
@author Mariow
@changelog
    v1.0 (2025-12-09)
    - Initial release (slips item contents forward using TimecodeUI nudge value)
@provides
    [main] ProTools_Essentials/Geeksound_SlipClipContentForward-TCui.lua
@link https://github.com/Geeksound/Reaper_Scripts-Mariow
@repository https://github.com/Geeksound/Reaper_Scripts-Mariow
@tags editing, slip, item, waveform, nudge, (protools-like)
@about
    # Slip Clip Content FORWARD by Nudge Value
    
    Slips the **audio content (waveform)** inside selected items **forward**
    ...
    ## 🟩 Usage
    - Moves item contents forward by the nudge value.
...
local function slip_Forward()
  ...
  reaper.Undo_EndBlock('Slip Forward (Waveform)', -1)
end
