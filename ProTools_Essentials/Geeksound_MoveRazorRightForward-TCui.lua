--[[
@description Move RIGHT-Edge of Razor Areas Forward by Nudge Value (TimecodeUI)
@version 1.0
@author Mariow
@changelog
    v1.0 (2025-12-09)
    - Initial release (moves right edge of Razor Areas forward using TimecodeUI nudge value)
@provides
    [main] ProTools_Essentials/Geeksound_MoveRazorRightForward-TCui.lua
@link https://github.com/Geeksound/Reaper_Scripts-Mariow
@repository https://github.com/Geeksound/Reaper_Scripts-Mariow
@tags editing, razor, nudge, items, transport, (protools-like)
@about
    # Move RIGHT Edge of Razor Areas Forward by Nudge Value (ProTools-like)
    
    This script moves the **right edge** of all Razor Areas forward according to the
    ...
    ## 🟩 Usage
    - Moves the right edge of each Razor Area forward by the nudge value.  
...
-- Créer Razor Areas depuis la Time Selection
...
local function move_right(direction)
    ...
    reaper.Undo_EndBlock("Move Razor Right Forward", -1)
end
