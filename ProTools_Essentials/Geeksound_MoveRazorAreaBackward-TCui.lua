--[[
@description Move Razor Areas Backward by Nudge Value (TimecodeUI)
@version 1.0
@author Mariow
@changelog
    v1.0 (2025-12-09)
    - Initial release (moves all Razor Areas backward using TimecodeUI nudge value)
@provides
    [main] ProTools_Essentials/Geeksound_MoveRazorAreaBackward-TCui.lua
@link https://github.com/Geeksound/Reaper_Scripts-Mariow
@repository https://github.com/Geeksound/Reaper_Scripts-Mariow
@tags editing, razor, nudge, items, transport, (protools-like)
@about
    # Move Razor Areas Backward by Nudge Value (ProTools-like)
    
    This script moves all **Razor Areas** backward in REAPER according to the nudge value
    ...
    ## 🟩 Usage
    - Moves each Razor Area backward by the nudge value.  
...
local function move_backward()
    ...
    reaper.Undo_EndBlock("Move Razor Areas Backward", -1)
end
