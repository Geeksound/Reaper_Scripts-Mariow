--[[
@description Move Time Selection START Backward by Nudge Value (TimecodeUI)
@version 1.0
@author Mariow
@changelog
    v1.0 (2025-12-09)
...
@provides
    [main] ProTools_Essentials/Geeksound_MoveTimeSelStartBackward-TCui.lua
@link https://github.com/Geeksound/Reaper_Scripts-Mariow
@repository https://github.com/Geeksound/Reaper_Scripts-Mariow
@tags editing, timesel, nudge, transport, (protools-like)
@about
    # Move Time Selection START Forward or Backward by Nudge Value
    
    Moves the **start point** of the current Time Selection forward or backward
    ...
    ## 🟩 Usage
    - Moves the start of the Time Selection forward (+1) or backward (-1).
...
local function move_timesel_start(direction)
    ...
    -- (tu peux enlever ce check si tu veux autoriser l’inversion)
...
----------------------------------------------------
-- CONFIG : choisir la direction ici
-- direction = -1 → backward
-- direction = +1 → forward
----------------------------------------------------
local direction = -1   -- ← créer version backward
-- local direction = +1   -- ← pour version forward
